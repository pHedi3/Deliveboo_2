<template>
    <div class="back" >
        <div class="loading" v-show="loadingCourse && loadingRestaurant && loadingDish">
            caricamento...
        </div>
                        ...
                        <div class="col-12">
                            <div class="course">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button @click="flagCheck =!flagCheck"><i class="fas fa-sort-down"></i></button>
                                </div>
                            ...
                            instance.requestPaymentMethod(function (err, payload) {
                                ...
                                if (response.data.success) {
                                    axios.post("/api/orders", order ).then((response) => {
                                        console.log(response.data.data);
                                        document.getElementById('risultato').innerHTML = 'transizione avvenuta'
                                    });
                                }
                            });
                        });
